...
public class FavDisplay extends LinearLayout{
	...
	private void setupDisplay(Context context){
		...
		_urlArray.add("Select Favorite");
		
		//CREATE SPINNER
		_list = new Spinner(_context);
		lp = new LayoutParams(0,LayoutParams.WRAP_CONTENT,1.0f);
		_list.setLayoutParams(lp);
		ArrayAdapter<String> listAdapter = new ArrayAdapter<String>(_context, android.R.layout.simple_spinner_item, _urlArray);
