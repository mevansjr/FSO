...
public class GetServiceJokes  extends IntentService{
    URL finalURL = null;
    int _result;
    ...
    public GetServiceJokes() {
        super("GetServiceJokes");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (extras != null) {
        	...
        	String responseString = "http://api.icndb.com/jokes/random/"+_passedItem;
